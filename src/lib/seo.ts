...
export const PUBLIC_PAGES: SitemapPage[] = [
  ...
  { canonicalPath: "/news", title: "{Location} {Team} News and Original Analysis", description: "Read original {Location} {Team} news and analysis covering roster decisions, injuries, games and the {Division}, with every published story in one archive." },
  ...
  { canonicalPath: "/standings", title: "2026 {Location} {Team} {Division} Standings", description: "Track {Location}'s 2026 {Division} position, record and division results once games begin, with preseason and regular-season records clearly separated." },
  ...
  { canonicalPath: "/history", title: "{Location} {Team} History, Eras and Franchise Players", description: "Explore a sourced guide to {Location} {Team} history, including franchise milestones, defining eras, notable players and fan traditions." },
